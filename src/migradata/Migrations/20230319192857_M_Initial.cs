...
{
    /// <inheritdoc />
    public partial class M_Initial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CNPJBase = table.Column<string>(type: "varchar(8)", nullable: true),
                    CNPJOrdem = table.Column<string>(type: "varchar(4)", nullable: true),
                    CNPJDV = table.Column<string>(type: "varchar(2)", nullable: true),
                    ...
                    MotivoSituacaoCadastral = table.Column<string>(type: "varchar(2)", nullable: true),
                    ...
                    TipoLogradouro = table.Column<string>(type: "varchar(255)", nullable: true),
