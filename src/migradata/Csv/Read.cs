...
public class Read
{
    ...
    public async Task MigraSociosAsync()
        => await Task.Run(async () =>
        {
            ...
            _timer.Start();
            await _data.WriteAsync(@"DELETE FROM Socios WHERE NOT EXISTS (SELECT 1 FROM Empresas WHERE Empresas.CNPJBase = Socios.CNPJBase)");
    ...
    public async Task MigraSimplesAsync()
        => await Task.Run(async () =>
        {
            ...
            try
            {
                ...
                await _data.WriteAsync(@"DELETE FROM Simples WHERE NOT EXISTS (SELECT 1 FROM Empresas WHERE Empresas.CNPJBase = Simples.CNPJBase)");
